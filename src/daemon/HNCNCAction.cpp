...
void
HNCNCAction::setType( HNCNC_ATYPE_T type )
{
    m_type = type;
}

void
HNCNCAction::setNewID( std::string id )
{
    m_newID = id;
}

void
HNCNCAction::setRequestCaptureID( std::string id )
{
    m_reqCaptureID = id;
}

std::string
HNCNCAction::getRequestCaptureID()
{
...
void
HNCNCAction::setResponseJSON( std::string jsonStr )
{
    m_rspStr = jsonStr;
}
...
bool 
HNCNCAction::hasRspContent( std::string &contentType )
{
    contentType.clear();
...
bool 
HNCNCAction::hasNewObject( std::string &newID )
{
    newID.clear();
...
bool 
HNCNCAction::generateRspContent( std::ostream &ostr )
{
    switch( m_type )
    {
        case HNCNC_ATYPE_GET_STATUS:
        ...
        case HNCNC_ATYPE_MODIFIERSLIST:
        {
            // Create a json root object
            pjs::Array jsRoot;
        ...
        case HNCNC_ATYPE_SEQUENCESLIST:
        {
            // Create a json root object
            pjs::Array jsRoot;
        ...
        case HNCNC_ATYPE_OPERATIONSLIST:
        {
            // Create a json root object
            pjs::Array jsRoot;
        ...
        case HNCNC_ATYPE_OPERATIONINFO:
        {
            // Create a json root object
            pjs::Object      jsRoot;
        ...
        case HNCNC_ATYPE_SCHINFO:
        case HNCNC_ATYPE_IRRSTATUS:
