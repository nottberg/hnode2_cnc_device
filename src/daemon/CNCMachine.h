...
class CNCSequencer : public CNCEventCB, CmdSequenceEventCallback, CANDeviceEventSink
{
    public:
        CNCSequencer();
       ~CNCSequencer();
        ...
        CNCM_RESULT_T registerWithEventLoop( CNCEventLoop *loop );
        ...
        std::string getSequenceDefinitionJsonStr( std::string seqID );
